...
export default function Watchlist() {
  ...
  return (
    <div className="space-y-10 animate-fade-in">
      ...
      {error && (
        <div className="rounded-2xl border border-red-500/20 bg-red-500/10 p-4 text-sm text-red-200 font-ui">
          {error}
        </div>
      )}
      ...
      {watchlist.length === 0 ? (
        <div className="pt-8">
          <EmptyState
            ...
            description="Start exploring anime to build your collection."
            action={
